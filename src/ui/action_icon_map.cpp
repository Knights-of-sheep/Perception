...
const ActionSpec kActions[] = {
    ...
    {"action.toggleFileDock",      "数据面板",       "显示/隐藏数据面板",        "view-panel-data",        true,  true,  true,  true,  false},
    {"action.togglePropertyDock",  "属性面板",       "显示/隐藏属性面板",        "view-panel-property",    true,  true,  true,  true,  false},
    {"action.togglePythonConsole", "Python 控制台",  "显示/隐藏 Python 控制台",  "view-panel-console",     true,  true,  true,  true,  false},
