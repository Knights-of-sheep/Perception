...
const ActionSpec kActions[] = {
    ...
    {"action.resetLayout",    "Reset Layout",           "Restore the default layout",        "view-reset-camera",      false, true,  true,  false, false},
    {"action.vtkLog",         "VTK Log Interception",   "Toggle VTK log interception",       "tools-settings",         false, true,  true,  false, false},
    {"action.openLogDir",     "Open Log Directory",     "Open the log directory in the file manager", "tools-settings", false, true, true, false, false},
    {"action.setLogPath",     "Set Log Path…",          "Choose where log files are saved",  "tools-settings",         false, true,  true,  false, false},
